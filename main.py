...
nazwa = ["Styczniu", "Lutym", "Marcu","Kwietniu","Maju","Czerwcu","Lipcu","Sierpniu","Wrześniu","Październiku",
...
while i < len(inflacja):
    wzor1 = (1 + ((inflacja[i] + kwota_oprocentowania) / (1000 + kwota_raty))) * kwota_kredytu - kwota_raty
    kwota_kredytu = wzor1
